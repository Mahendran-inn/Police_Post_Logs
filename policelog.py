...
st.markdown(f""" Your Search Result: A {driver_age} year-old {driver_gender} driver in {country_name} was stopped for {drugs_related_stop} at {stop_time.strftime('%I:%M %p')} on {stop_date}""") 